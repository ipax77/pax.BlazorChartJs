...
public partial class ChartJsBarVerticalSample
{
    ...
    protected override string SampleId => "vertical";

    protected override string Title => "Vertical Bar Chart";

    protected override string DocsHref => "https://www.chartjs.org/docs/latest/samples/bar/vertical.html";
        ...
        var config = new ChartJsConfig
        {
            ...
            Options = new ChartJsOptions
            {
                ...
                Plugins = new Plugins
                {
                    ...
                    Title = new Title { Display = true, Text = "Chart.js Bar Chart" },
                },
            },
        };
        """,
